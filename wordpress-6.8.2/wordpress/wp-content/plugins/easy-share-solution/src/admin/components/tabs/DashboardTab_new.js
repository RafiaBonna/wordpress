...
const DashboardTab = ({ settings, isProActive }) => {
    return (
        <div className="ess-dashboard-tab">
            ...
            <Card className="ess-quick-actions-card">
                <CardBody>
                    <h3>{__('Quick Actions', 'easy-share-solution')}</h3>
                    <div className="ess-quick-actions">
                        <Button 
                            ...
                            href="#platforms"
                        >
                            {__('Configure Platforms', 'easy-share-solution')}
                        </Button>
                        <Button 
                            isSecondary 
                            className="ess-quick-action-btn"
                    ...
                    <CardBody>
                        <div className="ess-pro-upgrade-content">
                            ...
                            <div className="ess-pro-upgrade-actions">
                                <Button isPrimary size="large" href="#" className="ess-upgrade-btn">
                                    {__('Upgrade Now', 'easy-share-solution')}
                                </Button>
                                <Button isLink href="#" className="ess-learn-more-btn">
