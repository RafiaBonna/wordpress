...
<section class="blog-area inarea-blog-2-column-area three">
	<div class="container">
		<div class="row">
			<?php 
	            $jewellery_boutique_archive_sidebar_setting = get_theme_mod('jewellery_boutique_archive_sidebar_setting','1');
	            $jewellery_boutique_sidebar_position = get_theme_mod('jewellery_boutique_sidebar_position', 'right');
	            $jewellery_boutique_content_class = ($jewellery_boutique_archive_sidebar_setting == '') ? 'col-lg-12' : 'col-lg-8';
			...
			<?php if( $jewellery_boutique_archive_sidebar_setting != '') { ?> 
                <?php get_sidebar(); ?>
            <?php } ?>
		</div>
	</div>
