...
<section class="blog-area inarea-blog-2-column-area three">
	<div class="container">
		<div class="row">
			<?php 
	            $jewellery_boutique_index_sidebar_setting = get_theme_mod('jewellery_boutique_index_sidebar_setting','1');
	            $jewellery_boutique_sidebar_position = get_theme_mod('jewellery_boutique_sidebar_position', 'right');
	            $jewellery_boutique_content_class = ($jewellery_boutique_index_sidebar_setting == '') ? 'col-lg-12' : 'col-lg-8';
			...
			<div class="<?php echo esc_attr($jewellery_boutique_content_class . ' ' . $jewellery_boutique_content_order_class); ?>">
				<div class="row">
					<?php 
						$jewellery_boutique_paged = ( get_query_var('paged') ) ? get_query_var('paged') : 1;
						$args = array( 'post_type' => 'post','paged'=>$jewellery_boutique_paged );	
					?>
					<?php if( have_posts() ): ?>
			...
			<?php if( $jewellery_boutique_index_sidebar_setting != '') { ?> 
                <?php get_sidebar(); ?>
            <?php } ?>
		</div>
	</div>
