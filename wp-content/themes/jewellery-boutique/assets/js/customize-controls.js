( function( $ ) {
  var this_obj = jewellery_boutique_customizer_params;
  ...
  api.bind( 'pane-contents-reflowed', function() {
    ...
    api.section.each( function( section ) {
      ...
      if (
        'jewellery_boutique_section' !== section.params.type ||
    ...
    api.panel.each( function( panel ) {
      ...
      if (
        'jewellery_boutique_panel' !== panel.params.type ||
  ...
  wp.customize.Panel = wp.customize.Panel.extend({
    attachEvents: function() {
      ...
      if (
        'jewellery_boutique_panel' !== this.params.type ||
  ...
  wp.customize.Section = wp.customize.Section.extend({
    attachEvents: function() {
      if (
        'jewellery_boutique_section' !== this.params.type ||
...
(function (api) {
  ...
  api.Tab = api.Control.extend({
    ready: function () {
      var control = this;
      control.container.find('a.jewellery-boutique-customizer-tab').click(function (evt) {
        var tab = jQuery(this).data('tab');
        evt.preventDefault();
        control.container.find('a.jewellery-boutique-customizer-tab').removeClass('active');
  ...
  jQuery.extend(api.controlConstructor, {
    'jewellery-boutique-tab': api.Tab
  });
