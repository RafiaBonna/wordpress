...
if ( ! class_exists( 'Jewellery_Boutique_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Jewellery_Boutique_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'jewellery_boutique_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function jewellery_boutique_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Jewellery_Boutique_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'jewellery_boutique_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function jewellery_boutique_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Jewellery_Boutique_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
