...
<div id="post-<?php the_ID(); ?>" <?php post_class('blog-item'); ?>>
    <?php
        ...
        $jewellery_boutique_post_id = get_the_ID(); // Add this line to get the post ID
        $jewellery_boutique_gallery_shortcode = get_post_gallery();

        if (!empty($jewellery_boutique_gallery_shortcode)) {
            // Display the gallery
            echo '<div class="embedded-gallery">' . do_shortcode($jewellery_boutique_gallery_shortcode) . '</div>';
        }
    ?>
