...
class FAQLY_Metabox {
    ...
    public function __construct() {
        ...
        add_action( 'save_post', [ 'Faqly_General_Settings_Metabox', 'faqly_save_metabox' ] ); // Save General Settings
    ...
    public function faqly_render_faq_group_metabox( $post ) {
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link <?php echo ( $active_tab === 'faq-custom' ) ? 'active' : ''; ?>" 
                        id="faq-custom-tab" data-bs-toggle="pill" data-bs-target="#faq-custom" 
                        type="button" role="tab" aria-controls="faq-custom" 
                        aria-selected="<?php echo ( $active_tab === 'faq-custom' ) ? 'true' : 'false'; ?>">
                    Custom
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link <?php echo ( $active_tab === 'faq-post' ) ? 'active' : ''; ?>" 
                        id="faq-post-tab" data-bs-toggle="pill" data-bs-target="#faq-post" 
                        type="button" role="tab" aria-controls="faq-post" 
        ...
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade <?php echo ( $active_tab === 'faq-custom' ) ? 'show active' : ''; ?>" 
                 id="faq-custom" role="tabpanel" aria-labelledby="faq-custom-tab">
                <?php include FAQLY_PLUGIN_DIR . 'tab/faq-custom-tab-content.php'; ?>
            </div>
            <div class="tab-pane fade <?php echo ( $active_tab === 'faq-post' ) ? 'show active' : ''; ?>" 
                 id="faq-post" role="tabpanel" aria-labelledby="faq-post-tab">
