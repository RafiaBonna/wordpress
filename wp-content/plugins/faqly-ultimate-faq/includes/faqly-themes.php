<header>
    <div>
        <div>
            ...
            <p class="faqly-para">Experience the most innovative, intuitive, and lightning-fast WordPress theme. Create your next website visually, quickly, and effortlessly.</p>
        </div>

        <!-- new add -->
        <ul class="faqly-navigation nav nav-pills " id="pills-tab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Premium Templates</button>
            </li>
        </ul>
    </div>
</header>
        ...
        <div id="faqly-block-tab">
            ...
            <div class="support-container">
                <div class="support-content">
                    ...
                    <p>Have a question or need assistance with the theme? Feel free to submit a support ticket or connect with our helpful community on our website.</p>
                    <div class="support-buttons">
                        <a class="sup-btn" target="_blank" href="<?php echo esc_url( FAQLY_PLUGIN_MAIN_URL . 'pages/community' ); ?>">Submit a Support Ticket</a>
                    </div>
                </div>
            </div>
        </div>
